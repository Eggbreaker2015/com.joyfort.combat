...
{
    [Serializable]
    public sealed class BattleStatusStackCountConditionOperandConfig : BattleConditionOperandConfig
    {
        ...
        public BattleStatusStackCountConditionOperandConfig()
        {
        }

        public BattleStatusStackCountConditionOperandConfig(BattleConditionSubject subject, BattleStatusConditionFilterConfig statusFilter)
        {
            _subject = subject;
        ...
        {
            return BattleConditionOperandDefinition.StatusStackCount(
                _subject,
